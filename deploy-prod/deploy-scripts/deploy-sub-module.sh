...
ssh gituser@$PRODIP "cd $LIVELOCBASE/$LIVLOC/$LIVLOCSUB;cd ..;sudo rm -Rf system;sudo git clone ssh://gituser@$LOCALIP$DEPLRP ./$LIVLOCSUB/;sudo chmod -R 775 $LIVELOCBASE/$LIVLOC/$LIVLOCSUB;sudo chown -R $SITEUSER $LIVELOCBASE/$LIVLOC/$LIVLOCSUB;sudo chgrp -R $SITEGRP $LIVELOCBASE/$LIVLOC/$LIVLOCSUB;"
cd $DSCRIPTS
